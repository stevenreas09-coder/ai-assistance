...
export default function Example() {
  return (
    <div className="px-4 bg-black/60 flex flex-col min-h-screen text-white">
      {/* Header */}
      ...
      <div className="w-full border-4 border-black box-border p-2 flex flex-col gap-2 flex-1 overflow-hidden">
        <div className="w-full h-60 border bg-violet-500/20 p-2">
          AI response
        </div>
        <div className="w-full h-px bg-black"></div>

        {/* Live text rendering area: grows but scrolls if too big */}
        <div className="w-full border bg-amber-500/20 p-2 min-h-[80px] max-h-[200px] overflow-y-auto">
          {/* Example text */}
