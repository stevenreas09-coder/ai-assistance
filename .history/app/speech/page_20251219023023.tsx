...
export default function Example() {
  ...
  const [isParsing, setIsParsing] = useState(false); // Only for PDF upload
  const [isThinking, setIsThinking] = useState(false); // Only for AI Send
