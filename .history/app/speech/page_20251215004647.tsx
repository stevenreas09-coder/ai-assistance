  ...
  return (
    <div className="flex flex-col px-4 py-1 text-xs text-black ">
      ...
      <div className="flex flex-col gap-2 min-h-0">
        ...
        <div className="w-full border font-semibold bg-amber-500/20 px-2 whitespace-pre-wrap h-[150px]">
          <div className="h-[30%] w-full divide-x-2 bg-amber-500/40 border overflow-hidden">
            {transcript}
          </div>
          <div className="h-[70%] w-full overflow-y-auto bg-white/20 border">
            {transcriptFinal}
          </div>
        </div>
      </div>
