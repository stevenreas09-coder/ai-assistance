...
export default function Example() {
  return (
    <div className="px-4 bg-white/20 flex flex-col min-h-auto text-xs text-white">
      {/* Header */}
      ...
      <div className="w-full border-4 border-black box-border p-2 flex flex-col gap-2">
