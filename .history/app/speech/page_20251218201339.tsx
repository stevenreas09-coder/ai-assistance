...
export default function Example() {
  ...
  return (
    <div className="flex flex-col px-4 py-1 bg-black/20 text-xs rounded-2xl border text-white ">
      {/* Top controls */}
      <div className=" flex flex-row justify-between items-center gap-2">
        <div className="flex gap-1">
          <select
            className=" bg-white/50 text-black rounded-sm"
          ...
          <h1 className="bg-white/30 rounded-sm px-2">Upload resume</h1>
        </div>
        <div className="px-2 bg-white/20">
      ...
      <div className="flex flex-col gap-1 min-h-0">
        {/* AI response box */}
        <div className="w-full h-[200px] rounded-2xl border border-black/30 overflow-y-auto whitespace-pre-wrap font-semibold bg-white/20 p-2">
          {output}
        </div>
