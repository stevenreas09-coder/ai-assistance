    ...
    <div className="flex flex-col px-4 py-1 text-xs text-black ">
      ...
      <div className="flex flex-col gap-2 min-h-0">
        ...
        <div className="w-full border font-semibold bg-amber-500/20 h-[150px]">
          <div className="h-[30%] whitespace-pre-wrap w-full divide-x-2 p-1 bg-amber-500/40 border overflow-hidden">
            {transcript}
          </div>
          <div className="h-[70%] whitespace-pre-wrap w-full p-1 overflow-y-auto bg-white/20 border">
            {transcriptFinal}
          </div>
        </div>
      </div>
