...
export default function () {
  return (
    <div className="p-4 bg-white/30 flex flex-col gap-2 items-center min-h-screen text-white overflow-y-scroll scrollbar scrollbar-thumb-gray-500 scrollbar-track-gray-200">
