  ...
  return (
    <div className="flex flex-col h-full px-4 py-2 bg-black/5 text-xs text-white overflow-hidden">
      ...
      <div className="flex flex-col gap-2 flex-1 min-h-0 overflow-hidden">
        ...
        <div className="flex-1 h-[140px] rounded-xl border border-white/10 overflow-y-auto whitespace-pre-wrap font-medium bg-zinc-900/80 p-3 shadow-inner custom-scrollbar">
          {output || (
