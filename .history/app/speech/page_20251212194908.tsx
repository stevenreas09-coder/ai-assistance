...
export default function () {
  return (
    <div className="p-4 bg-white/30 flex flex-col gap-2 items-center min-h-screen text-white overflow-y-scroll scrollbar scrollbar-thumb-blue-500 scrollbar-track-gray-700 hover:scrollbar-thumb-blue-700">
