...
export default function Example() {
  ...
  return (
    <div className="flex flex-col px-4 py-1 bg-white/20 text-xs text-black ">
      {/* Top controls */}
      ...
      <div className="flex flex-col gap-2 min-h-0">
        {/* AI response box */}
        <div className="w-full h-[200px] border font-semibold bg-white/40 p-2">
          AI response
        </div>
        ...
        <div className="w-full border font-semibold bg-amber-white/20 h-[150px]">
          <div className="h-[30%]  w-full divide-x-2 p-2 bg-amber-500/40 border overflow-hidden">
            {transcript}
          </div>
          <div className="h-[70%] w-full p-1 overflow-y-auto bg-white/20 border">
            {transcriptFinal}
          </div>
        </div>
      </div>
