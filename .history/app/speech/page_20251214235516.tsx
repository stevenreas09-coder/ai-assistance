...
export default function Example() {
  ...
  return (
    <div className="flex flex-col h-screen px-4 py-2 text-xs text-black gap-2">
      {/* Top controls */}
      ...
      {/* Main content */}
      <div className="flex flex-col flex-grow gap-2 min-h-[100px]">
        {/* AI response box */}
        <div className="w-full h-[200] border font-semibold bg-violet-500/20 p-2">
          AI response
        </div>
        ...
        {/* Transcript box */}
        <div className="w-full border font-semibold bg-amber-500/20 p-2 flex-grow overflow-y-auto whitespace-pre-wrap max-h-[150px] min-h-[80px]">
          {transcript}
        </div>
      </div>
