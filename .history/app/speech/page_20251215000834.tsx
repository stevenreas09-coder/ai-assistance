...
export default function Example() {
  ...
  return (
    <div className="flex flex-col h-screen px-4 py-2 text-xs text-black ">
      {/* Top controls */}
      ...
      <div className="flex flex-col gap-2 min-h-0">
        ...
        <div className="w-full border font-semibold bg-amber-500/20 p-2 overflow-y-auto whitespace-pre-wrap max-h-[150px] min-h-[80px]">
          {transcript}
        </div>
      </div>

      {/* Buttons */}
      <div className="flex justify-between text-xs p-2 text-white font-semibold">
        <button
