  ...
  return (
    <div className="flex flex-col px-4 py-1 text-xs text-black ">
      ...
      <div className="flex flex-col gap-2 min-h-0">
        ...
        <div className="w-full border font-semibold bg-amber-500/20 whitespace-pre-wrap h-[150px]">
          <div className="h-[30%] w-full divide-x-2 p-1 bg-amber-500/40 border overflow-hidden">
            {transcript}
          </div>
